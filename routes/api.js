...
module.exports = function (app) {
  ...
  app.route('/api/issues/:project')
    ...
    .put(async (req, res) => {
      ...
      let targetIssueIndex = project.issues.findIndex(issue => issue._id == _id);

      // console.log(targetIssueIndex);
      ...
      for (let key in updates) {
        if (key !== '_id' && updates[key] != '') {
          project.issues[targetIssueIndex][key] = updates[key];
        }
      }
